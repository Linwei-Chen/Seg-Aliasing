...
sys.path.append('../../')
sys.path.append('../../../')
from mmseg_custom import models
# import models
...
def main():
    ...
    if not distributed:
        ...
        # data_loader.dataset = data_loader.dataset[:10]
        results = single_gpu_test(
            ...
            # pre_eval=args.eval is not None and not eval_on_format_results and args.pre_eval,  
            pre_eval=False,
